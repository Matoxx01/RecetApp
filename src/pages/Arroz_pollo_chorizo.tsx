  ...
  return (
    <IonPage>
      ...
      <IonContent className="ion-padding">
        ...
        <IonCheckbox labelPlacement="end"></IonCheckbox><b>    2.</b> Añade el pollo picado, cocínalo hasta que se dore ligeramente. Una vez listo, añade el chorizo en ruedas, remueve y añade el arroz. Mezcla bien, incorporando el arroz con el resto de ingredientes. Coloca el vino blanco, (si decidiste usarlo), la zanahoria, pimientos y arveja. Integra bien.
        <br /><br /><br />

        <IonCheckbox labelPlacement="end"></IonCheckbox><b>    3.</b> Añade el Puré de tomate La Rojita MAGGI®, el caldo de gallina en cubo de 4 g MAGGI® y el agua.
        <br /><br /><br />

        <IonCheckbox labelPlacement="end"></IonCheckbox><b>    4.</b> Cocina a fuego medio alto hasta llegar a la ebullición. Una vez que haya hervido, baja el fuego, tapa la olla y deja cocinar hasta que el arroz y los vegetales estén suaves y que el agua se haya evaporado.
      </IonContent>
    </IonPage>
  );
  };
