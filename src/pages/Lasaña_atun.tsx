...
return (
  <IonPage>
    ...
    <IonContent className="ion-padding">
        ...
        <IonCheckbox labelPlacement="end"></IonCheckbox><b>    2.</b> En un sartén grande coloca 3 cucharadas de mantequilla 2 cucharadas de aceite de achiote, y una ves caliente añade el cubo de Caldo de Gallina MAGGI® , una ves disuelto añade, cebolla, pimiento, tomate y cocina a fuego medio. Remueve constantemente y añade las hojas de laurel. la sal, la pimienta y el atún.
        <br /><br /><br />

        <IonCheckbox labelPlacement="end"></IonCheckbox><b>    3.</b> En una olla coloca mantequilla, Caldo Criollita MAGGI®.
        <br /><br /><br />

        <IonCheckbox labelPlacement="end"></IonCheckbox><b>    4.</b> Por aparte disuelve la maicena en una taza de Leche entera LA LECHERA® y llévala a calentar en la olla a fuego medio hasta que espese ligeramente, continua añadiendo el queso parmesano y reserva.
        <br /><br /><br />

        <IonCheckbox labelPlacement="end"></IonCheckbox><b>    5.</b> Engrasa un molde apto para horno, y coloca una capa de los fideos para lasaña reservados, cúbrelos con una capa del relleno de atún, coloca rodajas de queso mozzarella sobre el relleno, y cúbrelo con la salsa blanca, repite el proceso hasta terminar los ingredientes, lleva al horno cubierto de papel aluminio durante 15 minutos, retira el papel aluminio y deja dorar por 15 minutos adicionales, retira del horno y disfruta.
      </IonContent>
  </IonPage>
);
};
